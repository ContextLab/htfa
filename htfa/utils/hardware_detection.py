...
def detect_cuda() -> Dict[str, Any]:
    ...
    """
    result = {"available": False, "version": None, "device_count": 0, "devices": []}
...
def has_gpu() -> bool:
    ...
    """
    return (
        detect_cuda()["available"]
        or detect_metal()["available"]
        or detect_rocm()["available"]
        or detect_tpu()["available"]
    )
