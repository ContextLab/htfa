...
class Backend(ABC):
    ...
    @abstractmethod
    def clip(self, x: Any, min_val: Optional[Any] = None, max_val: Optional[Any] = None) -> Any:
    ...
    @abstractmethod
    def choice(self, a: Union[int, Any], size: Optional[Union[int, Tuple[int, ...]]] = None,
               replace: bool = True, p: Optional[Any] = None, seed: Optional[int] = None) -> Any:
