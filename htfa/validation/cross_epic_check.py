...
class CrossEpicValidator:
    ...
    def generate_report(self) -> str:
        ...
        available_components = sum(
            1 for epic_components in epic_results.values()
            for c in epic_components if c.available
        )
        ...
        report_lines.append(f"Components: {available_components}/{total_components} available")
        report_lines.append(f"Compatibility: {compatibility_pass}/{compatibility_total} passing")
