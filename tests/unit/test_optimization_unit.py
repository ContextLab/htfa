...
class TestMiniBatchOptimizer:
    ...
    def test_minibatch_initialization(self):
        ...
        opt = MiniBatchOptimizer(
            base_optimizer=base_opt, batch_size=128, n_epochs=5, shuffle=False
        )
    ...
    def test_minibatch_optimize(self):
        ...
        opt = MiniBatchOptimizer(
            base_optimizer=base_opt, batch_size=25, n_epochs=2, shuffle=True
        )
    ...
    def test_minibatch_no_shuffle(self):
        ...
        base_opt = AlternatingLeastSquares()
        opt = MiniBatchOptimizer(
            base_optimizer=base_opt, batch_size=10, n_epochs=1, shuffle=False
        )
...
class TestSparseOptimizer:
    ...
    def test_sparse_initialization(self):
        ...
        base_opt = AlternatingLeastSquares()
        opt = SparseOptimizer(
            base_optimizer=base_opt, sparsity_penalty=0.2, sparsity_type="l1"
        )
    ...
    def test_sparse_optimize_l1(self):
        ...
        base_opt = AlternatingLeastSquares(regularization=0.01)
        opt = SparseOptimizer(
            base_optimizer=base_opt, sparsity_penalty=0.1, sparsity_type="l1"
        )
    ...
    def test_sparse_optimize_l2(self):
        ...
        base_opt = AlternatingLeastSquares()
        opt = SparseOptimizer(
            base_optimizer=base_opt, sparsity_penalty=0.5, sparsity_type="l2"
        )
    ...
    def test_sparse_invalid_type(self):
        ...
        opt = SparseOptimizer(
            base_optimizer=AlternatingLeastSquares(), sparsity_type="invalid"
        )
